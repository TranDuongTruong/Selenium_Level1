...
//        Step 3:Click on "Change Password" tab
        ExtentTestManager.logMessage(Status.INFO,"Step 3:Click on \"Change Password\" tab");
...
//        Step 5:Click on "Change Password" button
        ...
        ExtentTestManager.logMessage(Status.INFO,"4.Enter valid value into all fields.");
        ExtentTestManager.logMessage(Status.INFO,"Step 5:Click on \"Change Password\" button");
